        ...
        <div id="signup">   
          ...
          <div class="field-wrap">
            <label>
              ...
              <input type="password"required autocomplete="off" name="contra"/>
          </div>
          
         
          
              <button type="submit" class="button button-block" name="Insertar"  onclick="return confirm('Registrado con exito')"/>Registrarse</button>
