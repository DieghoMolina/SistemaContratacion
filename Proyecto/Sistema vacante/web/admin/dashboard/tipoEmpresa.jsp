    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content" >
          ...
          <form action="../../procesarTipoEmpresa" method="get" name="frm" class="form-horizontal">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                  <%
                      List<TipoEmpresa> lt=cdt.mostrarTipoEmpresa();
                      for(TipoEmpresa tp:lt)
                      {
                  %>
                <tr class="odd gradeX">
                    <td><%= tp.getIdTipoEmpresa() %></td>
                  <td><%= tp.getNombre() %></td>
                  <td><a href="javascript:cargar(<%= tp.getIdTipoEmpresa()%>,'<%= tp.getNombre() %>')">Seleccionar</a></td>
                </tr> 
                <% } %>
              </tbody>
            </table>
