                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-brand navbar-right" style="margin-top: 40px;">
                                <a href="">Inicio</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="loginEmpresa.jsp">Ingresar como empresa</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div>
            ...
            <div id="templatemo-carousel" class="carousel slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li data-target="#templatemo-carousel_" data-slide-to="0" class="active"></li>
        ...
        <div class="templatemo-welcome" id="templatemo-welcome">
            <div class="container">
                <div class="templatemo-slogan text-center">
                    <span class="txt_darkgrey">Bienvenido </span><span class="txt_orange">Tecolocamos.com</span>
                    <p class="txt_slogan"><i>Trabajamos para llevarte las ofertas de empleo de las mejores empresas hasta tu ordenador!</i></p>
                </div>	
            </div>
        </div>
